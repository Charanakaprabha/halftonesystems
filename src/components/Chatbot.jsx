...
import { MessageSquare, Send, X, Bot, User, Maximize2, Minimize2, Settings, RotateCcw } from 'lucide-react';
            ...
            <div className={`chat-window ${isOpen ? 'open' : ''} ${isMaximized ? 'maximized' : ''}`}>
                <div className="chat-header">
                    <div className="header-info">
                        {!isMaximized && <div className="status-dot"></div>}
                        {!isMaximized && <Bot size={24} color="var(--c-primary)" />}
                        {isMaximized && (
                            <div className="brand-logo">
                                <img src={logo} alt="HTS" className="brand-img" />
                            </div>
                        )}
                        <h3>{isMaximized ? "" : "HTS IntelliAssist"}</h3>
                    </div>
                        ...
                        <div className="chat-input-area">
                            <form className="chat-input-form" onSubmit={handleSendMessage}>
                                <input
                                    ...
                                    placeholder={isMaximized ? "Ask Zoiee" : "Type your message..."}
                                    disabled={isLoading}
                                />
